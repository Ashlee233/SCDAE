...
plt.xlim(0, 8000)
plt.plot(np.arange(len(test_labels[81])), test_labels[81])
...
plt.figure(figsize=(15, 5))
plt.xlim(0, 8000)
plt.plot(np.arange(len(test_data[81])), test_data[81])
plt.xlabel('Time',fontdict={'weight': 'normal', 'size': 20})
plt.ylabel('Amplitude',fontdict={'weight': 'normal', 'size': 20})
...
plt.figure(figsize=(15, 5))
plt.xlim(0, 8000)
plt.plot(np.arange(len(decoded_data[81])), decoded_data[81])
plt.xlabel('Time',fontdict={'weight': 'normal', 'size': 20})
plt.ylabel('Amplitude',fontdict={'weight': 'normal', 'size': 20})
